                            ...
                            <div id="carousel5" class="carousel slide" data-bs-ride="carousel"> 
                                <div class="carousel-inner"> 
                                    ...
                                    <div class="carousel-item"> 
                                        ...
                                        <p class="small">Генеральный менеджер</p> 
                                    </div>                                     
                                </div>
                    ...
                    <div class="justify-content-center row"> 
                        <div class="col-lg-4 col-sm-6 pb-3 pt-3">
                            <div>
                                ...
                                <h2 class="fw-bold h5 mb-3 text-dark">Бесплатная доставка в России</h2>
                                <p class="mb-0">При заказе на сумму от 8.000 рублей</p>
                            </div>                             
                        </div>
                        <div class="col-lg-4 col-sm-6 pb-3 pt-3">
                            <div>
                                ...
                                <h2 class="fw-bold h5 mb-3 text-dark">100% Оригинал</h2>
                                <p class="mb-0">Сертификат о надлежащем качестве от производителя</p>
                            </div>                             
                        </div>
                        <div class="col-lg-4 col-sm-6 pb-3 pt-3">
                            <div>
                                ...
                                <p class="mb-0">Наши менеджеры всегда на связи в любое время года</p>
                            </div>                             
                        </div>                         
                    </div>                     
                </div>
