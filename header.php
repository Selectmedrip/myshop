<nav class="bg-white navbar navbar-expand-lg navbar-light py-lg-1"> 
            <div class="container"> <a class="fw-bold navbar-brand" href="index.php" target="">Анна Шоп</a>
                <ul class="flex-row ms-auto navbar-nav order-lg-1 ps-2 pe-2"> 
                    ...
                    <li class="nav-item"> <a id="view-cart-link" class="nav-link p-2 pb-3 ps-2 pe-2 pt-3" href="#cart" title="View Cart"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="2.25em" height="2.25em">
                                <g>
                                    <path fill="none" d="M0 0h24v24H0z"></path>
                    ...
                    <li class="nav-item"> <a class="nav-link pb-3 ps-2 pe-2 pt-3" href="./log_reg/login.html" title="Account"><span id="username_placeholder">Авторизация</span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="2.25em" height="2.25em">
                                <g>
                                    <path fill="none" d="M0 0h24v24H0z"></path>
